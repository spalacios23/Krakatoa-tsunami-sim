...
# ============================================================
STATIONS = [
    ("Port Blair",       11.67,  92.75,   4.0,    0.2,   'gauge',  5.2),
    ("Galle",             6.03,  80.22,   5.0,    1.0,   'runup',  5.3),
    ("Negombo",           7.21,  79.84,   7.0,    1.0,   'runup',  5.3),
    ("Bombay",           19.08,  72.87,  11.0,    0.56,  'gauge',  9.3),
    ("Rodriguez Is.",   -19.67,  63.42,   6.5,    1.8,   'runup',  6.8),
    ("Mauritius",       -20.17,  57.50,   6.5,    0.9,   'runup',  7.6),
    ("Cossack",         -20.68, 117.20,   5.25,   1.5,   'runup',  4.6),
    ("Geraldton",       -28.77, 114.60,   9.25,   1.0,   'runup',  4.3),
]
